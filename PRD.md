...
| M2 — MVP alpha | F1–F8 integrated, internal testing | ◐ F2/F3/F4/F5/F7 done, F1/F6/F8 partial (2026-08-30); remaining: F1 label surface, on-device testing. Note: F3 recon confirmed §13 risk 1 — only the US publishes per-number data (FTC+FCC); other countries rely on F7 heuristics until M3 |
